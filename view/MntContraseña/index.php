				...
				<div class="row">
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Nombre Completo</label>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								...
								<input type="tel" class="form-control" id="txtpass" name="txtpass">
							</fieldset>
						</div>

						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput">Fecha de Naciminto</label>
								<input type="date" class="form-control" id="txtpass" name="txtpass">
							</fieldset>
						</div>
